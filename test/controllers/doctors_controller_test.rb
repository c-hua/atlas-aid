...
class DoctorsControllerTest < ActionController::TestCase
  ...
  test "should create doctor" do
    assert_difference('Doctor.count') do
      post :create, doctor: { hospital: @doctor.hospital, name: @doctor.name, specialty: @doctor.specialty }
    end
  ...
  test "should update doctor" do
    patch :update, id: @doctor, doctor: { hospital: @doctor.hospital, name: @doctor.name, specialty: @doctor.specialty }
    assert_redirected_to doctor_path(assigns(:doctor))
  end
